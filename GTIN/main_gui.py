...
lib_products_gtin = tkinter.Listbox(w)
lib_products_desc = tkinter.Listbox(w)
lib_products_price = tkinter.Listbox(w)

lbl_entry.pack()
ent_entry.pack()
lib_products_gtin.pack()
lib_products_desc.pack()
lib_products_price.pack()
...
with open("C:\\Users\\admin\\Documents\\GitHub\\python-dingdongs\\GTIN\\products.csv", 'rU') as f:
    reader = csv.reader(f)
